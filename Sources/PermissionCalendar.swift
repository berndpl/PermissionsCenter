...
class PermissionCalendar: Permission, CLLocationManagerDelegate {
    ...
    override func request(){
        ...
        self.eventStore.requestAccessToEntityType(EKEntityTypeEvent) {
            ...
            dispatch_async(dispatch_get_main_queue()) {
                println("Request Result. Granted? \(granted)")
                    PermissionsCenter.shared.permissionButton?.stopPulseAnimation()
                ...
                if granted {
                    ...
                    var permission:Permission? = PermissionsCenter.shared.permissionOfType(PermissionType.Calendar)
                    if permission != nil {
                        PermissionsCenter.shared.actOnPermissionStatus(permission!)
                    }
                }
            }
        }
